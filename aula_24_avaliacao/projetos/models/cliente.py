class Cliente:
    ...
    def set_id_convenio(self, id_convenio):
        if id_convenio < 0: raise ValueError("O id do convênio deve ser informado")
    ...
    def to_json(self):
        return { "id":self.__id, "nome":self.__nome, "email":self.__email, "fone":self.__fone, "id_convnio": self.__id_convenio }
